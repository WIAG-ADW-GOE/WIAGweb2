...
The installation of the software mentioned below is mentioned [in detail here](https://github.com/WIAG-ADW-GOE/WIAGweb2/blob/main/notebooks/sync_notebooks/docs/Installation.md).
...
**Notebook**: [pr_recon.ipynb](https://github.com/WIAG-ADW-GOE/WIAGweb2/blob/main/notebooks/sync_notebooks/pr_recon.ipynb)
...
**Notebook**: [factgrid_recon.ipynb](https://github.com/WIAG-ADW-GOE/WIAGweb2/blob/main/notebooks/sync_notebooks/factgrid_recon.ipynb)
...
**Notebook**: [FactGrid-IDs2WIAG.ipynb](https://github.com/WIAG-ADW-GOE/WIAGweb2/blob/main/notebooks/sync_notebooks/FactGrid-IDs2WIAG.ipynb)
...
**Notebook**: [Csv2FactGrid-create.ipynb](https://github.com/WIAG-ADW-GOE/WIAGweb2/blob/main/notebooks/sync_notebooks/Csv2FactGrid-create.ipynb)
...
**Notebook**: [wiag_to_factgrid.ipynb](https://github.com/WIAG-ADW-GOE/WIAGweb2/blob/main/notebooks/sync_notebooks/wiag_to_factgrid.ipynb)
...
**Notebook**: [fg_to_pr.ipynb](https://github.com/WIAG-ADW-GOE/WIAGweb2/blob/main/notebooks/sync_notebooks/fg_to_pr.ipynb)
...
**Notebook**: [pr_to_fg.ipynb](https://github.com/WIAG-ADW-GOE/WIAGweb2/blob/main/notebooks/sync_notebooks/pr_to_fg.ipynb)
...
4. Run the notebook cell by cell.
5. Once completed, the notebook will generate `factgrid_pr_links.csv`.
6. Upload `factgrid_pr_links.csv` to FactGrid to update entries with PR links.
